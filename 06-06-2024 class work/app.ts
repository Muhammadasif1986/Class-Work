...
let Optional = (name:string,Bio_data?:(string | number | boolean)) => {
...
// Optional parameters use in object
interface product {
      name:string,
      Bio_data?:(string | number | boolean)
}
let product:product = {
      name:"asif",
      Bio_data:"age 23"
...
// LHS      RHS
// person2 = person;//show Error RHS Quantity less then LHS



// INDEX SIGNATURE: Using when you Unknown Quantity of properties in object
      // [X:string]:any
      // X/key is string type and any is any type of value

interface detail{
      name:string,
      id:number,
      [Property:string]:any//apply [Index signature]type
}
...
person = { // person name ka object phely se bana hua hia is may fresh value assign ki hai.
      name:"sultan",
      age:37
